...
def movePictures(moveDestination):
    source = os.listdir("/home/pi/ownDev/Camera/")
    destination = "/home/pi/ownDev/Camera/PicturesTaken/"
    for files in source:
...
def startLoop():
    ...
    try:
        while True:
            ...
            subprocess.call("raspistill -w 640 -h 480 -t 10  -o %s" %filename, shell = True)
